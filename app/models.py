...
class UserImageLink(Base):
    ...
    current_version_id: Mapped[int | None] = mapped_column(ForeignKey("image_versions.id", ondelete="SET NULL"))
...
class AuditEvent(Base):
    ...
    ts: Mapped[dt.datetime] = mapped_column(DateTime(timezone=True), default=lambda: dt.datetime.now(dt.UTC), nullable=False)
...
class Album(Base):
    ...
    created_at: Mapped[dt.datetime] = mapped_column(DateTime(timezone=True), default=lambda: dt.datetime.now(dt.UTC), nullable=False)
    updated_at: Mapped[dt.datetime] = mapped_column(DateTime(timezone=True), default=lambda: dt.datetime.now(dt.UTC), nullable=False)
...
class ImageTag(Base):
    ...
    tenant_id: Mapped[str | None] = mapped_column(UUID(as_uuid=False), primary_key=True, default="00000000-0000-0000-0000-000000000000")
    owner_user_id: Mapped[str | None] = mapped_column(UUID(as_uuid=False))
